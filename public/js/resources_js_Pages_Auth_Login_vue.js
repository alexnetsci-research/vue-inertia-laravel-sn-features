    ...
    [
      _c(
        ...
        [
          _c(
            "v-col",
            { attrs: { cols: "12", sm: "7", md: "5", lg: "3" } },
            [
              _c(
                "h1",
                {
                  staticClass: "text-center mb-1 display-4",
                          ...
                          _c("v-text-field", {
                            attrs: {
                              ...
                              "error-messages": _vm.$page.props.errors.password
                                ? _vm.$page.props.errors.password[0]
                                : [],
                            },
                            on: {
                              keydown: function ($event) {
                          ...
                          _c(
                            ...
                            [
                              _c(
                                ...
                                {
                                  staticClass:
                                    "col-9 font-weight-bold rounded-tl-xl",
                                  attrs: {
                                    color: "light-blue darken-2",
                                    dark: "",
                                    large: "",
                          ...
                          _c(
                            ...
                            [
                              _c(
                                ...
                                {
                                  staticClass:
                                    "col-9 font-weight-bold rounded-br-xl",
                                  attrs: {
